...
export declare const SCHEDULE_INTERVAL_OPTIONS: readonly ["mon-fri", "sat-sun", "working-hours", "morning-evening", "night"];
...
export interface TaskContext {
    ...
    log: (level: 'info' | 'warn' | 'error' | 'debug', message: string, payload?: Record<string, unknown>) => Promise<void>;
